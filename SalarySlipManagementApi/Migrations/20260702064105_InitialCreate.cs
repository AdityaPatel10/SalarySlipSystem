    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlySalarySlips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthlySalarySlip_Employee",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BasicSalary = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HRAPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OtherAllowancesPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PFDeductionPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TaxDeductionPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryStructure_Employee",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlySalarySlips_EmployeeId",
                table: "MonthlySalarySlips",
                column: "EmployeeId");
